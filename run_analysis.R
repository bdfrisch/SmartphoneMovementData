...
All_data_MeansStd<-All_data_MeansStd[order(All_data_MeansStd$SubjectID,
                                           All_data_MeansStd$ActivityIndex),] 
        
## Define names for the activities in the data set as labels for the ##
## ActivityIndex factor ##
...
## Create a new data set that contains the average for each variable, for each 
## activity and each subject
SubjectMeans<-ddply(All_data_MeansStd, .(SubjectID, ActivityIndex), numcolwise(mean))

## Export the tidy data set to 
